...
class Main: 
    ...
    def append_rows_to_csv(self, new_rows):
        ...
        new_data = pd.DataFrame(new_rows, columns=['Model', 'Accuracy', 'Precision', 'Recall', 'F1-score'])
    ...
    def run(self):
        ...
        clf = LazyClassifier(verbose=0,ignore_warnings=True, custom_metric=None, predictions=True, classifiers=self.select_classifiers())
